...
export const signupSchema = joi.object({
  ...
  shareProfileName: joi.string().min(3).max(30).required().messages({
    "string.base": "Share profile name should be a string",
    "string.empty": "Share profile name cannot be empty",
  }),
